 ...
 */ !function(e) {
    ...
    return (function e(t, n, r) {
        ...
        1: [
            function(e, t, n) {
                !function(e, r) {
                    ...
                    var _ = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, E = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, w = Object.prototype, k = w.hasOwnProperty, I = w.toString;
                    function D(e, t) {
                        return k.call(e, t);
                    }
                    ...
                    function V(e) {
                        ...
                        return C(t.onComment) && (t.onComment = function(e, t) {
                            return function(n, r, i, s, a, o) {
                                ...
                                e.locations && (u.loc = new R(this, a, o)), e.ranges && (u.range = [
                                    i,
                                    s
                                ]), t.push(u);
                            };
                    ...
                    U.isLet = function(e) {
                        ...
                        var t = E.exec(this.input), n = this.pos + t[0].length, r = this.input.charCodeAt(n);
                        if (91 === r) return !0;
                        if (e) return !1;
                        if (123 === r) return !0;
                        if (p(r, !0)) {
                        ...
                        E.lastIndex = this.pos;
                        var e = E.exec(this.input), t = this.pos + e[0].length;
                        ...
                        switch(this.isLet(e) && (i = T._var, r = "let"), i){
                            ...
                            case T._import:
                                if (this.options.ecmaVersion > 10 && i === T._import) {
                                    E.lastIndex = this.pos;
                                    var a = E.exec(this.input), o = this.pos + a[0].length;
                            ...
                            default:
                                ...
                                var u = this.value, l = this.parseExpression();
                        ...
                        var s = new G, a = this.parseExpression(!0, s);
                        ...
                        for(var n = !1; this.type !== T.braceR;)if (this.type === T._case || this.type === T._default) {
                    ...
                    U.parseFunction = function(e, t, n, r) {
                        ...
                        var n = this.startNode(), r = function(e, r) {
                            void 0 === r && (r = !1);
                        ...
                        else if ("ObjectPattern" === n) for(var r = 0, i = t.properties; r < i.length; r += 1){
                            var s = i[r];
                    ...
                    q.toAssignable = function(e, t, n) {
                        ...
                        for(var r = [], i = !0; !this.eat(e);)if (i ? i = !1 : this.expect(T.comma), t && this.type === T.comma) r.push(null);
                        else {
                    ...
                    Y.checkPropClash = function(e, t, n) {
                        ...
                        if (this.type === T.comma) {
                            ...
                            for(s.expressions = [
                                i
                            ]; this.eat(T.comma);)s.expressions.push(this.parseMaybeAssign(e, t));
                        ...
                        var n = this.start, r = this.startLoc, i = this.parseMaybeUnary(t, !1);
                        ...
                        if (null != s && (!i || this.type !== T._in) && s > r) {
                            var a = this.type === T.logicalOR || this.type === T.logicalAND, o = this.value;
                            this.next();
                            var u = this.start, l = this.startLoc, h = this.parseExprOp(this.parseMaybeUnary(null, !1), u, l, s, i), c = this.buildBinary(t, n, e, h, o, a);
                        ...
                        if (this.isContextual("await") && (this.inAsync || !this.inFunction && this.options.allowAwaitOutsideFunction)) n = this.parseAwait(), t = !0;
                            ...
                            var s = this.startNode(), a = this.type === T.incDec;
                        ...
                        var t = this.start, n = this.startLoc, r = this.parseExprAtom(e);
                        ...
                        if (s || this.eat(T.dot)) {
                            ...
                            var o = new G, u = this.yieldPos, l = this.awaitPos, h = this.awaitIdentPos;
                        ...
                        switch(this.type){
                            ...
                            case T.name:
                                var r = this.start, i = this.startLoc, s = this.containsEsc, a = this.parseIdent(!1);
                                ...
                                if (n && !this.canInsertSemicolon()) {
                                    if (this.eat(T.arrow)) return this.parseArrowExpression(this.startNodeAt(r, i), [
                                        a
                                    ], !1);
                                    if (this.options.ecmaVersion >= 8 && "async" === a.name && this.type === T.name && !s) return a = this.parseIdent(!1), !this.canInsertSemicolon() && this.eat(T.arrow) || this.unexpected(), this.parseArrowExpression(this.startNodeAt(r, i), [
                                        a
                                    ], !0);
                                }
                                return a;
                            ...
                            case T.parenL:
                                var u = this.start, l = this.parseParenAndDistinguishExpression(n);
                        ...
                        if (this.options.ecmaVersion >= 6) {
                            this.next();
                            var s, a = this.start, o = this.startLoc, u = [], l = !0, h = !1, c = new G, p = this.yieldPos, d = this.awaitPos;
                            ...
                            var m = this.start, f = this.startLoc;
                    ...
                    Y.parseNew = function() {
                        ...
                        var r = this.start, i = this.startLoc, s = this.type === T._import;
                        ...
                        for(n.quasis = [
                            r
                        ]; !r.tail;)this.type === T.eof && this.raise(this.pos, "Unterminated template literal"), this.expect(T.dollarBraceL), n.expressions.push(this.parseExpression()), this.expect(T.braceR), n.quasis.push(r = this.parseTemplateElement({
                            isTagged: t
                        }));
                        ...
                        var r = this.yieldPos, i = this.awaitPos, s = this.awaitIdentPos;
                        ...
                        var r = t && this.type !== T.braceL, i = this.strict, s = !1;
                    ...
                    var Q = O.prototype, ee = function(e) {
                    ...
                    var te = function(e, t, n) {
                        this.type = "", this.start = t, this.end = 0, e.options.locations && (this.loc = new R(e, n)), e.options.directSourceFile && (this.sourceFile = e.options.directSourceFile), e.options.ranges && (this.range = [
                            t,
                            0
                        ]);
                    }, ne = O.prototype;
                    ...
                    fe(9), fe(10), fe(11);
                    var ge = O.prototype, xe = function(e) {
                    ...
                    xe.prototype.reset = function(e, t, n) {
                        ...
                        var t = e.pos, n = e.current();
                        return e.advance(), 92 === n && this.regexp_eatRegExpUnicodeEscapeSequence(e) && (n = e.lastIntValue), function(e) {
                    ...
                    var ke = function(e) {
                        this.type = e.type, this.value = e.value, this.start = e.start, this.end = e.end, e.options.locations && (this.loc = new R(e, e.startLoc, e.endLoc)), e.options.ranges && (this.range = [
                            e.start,
                            e.end
                        ]);
                    }, Ie = O.prototype;
                    ...
                    Ie.next = function(e) {
                        ...
                        if (-1 === r && this.raise(this.pos - 2, "Unterminated comment"), this.pos = r + 2, this.options.locations) for(S.lastIndex = n; (e = S.exec(this.input)) && e.index < this.pos;)++this.curLine, this.lineStart = e.index + e[0].length;
                        ...
                        var t = this.input.charCodeAt(this.pos + 1), n = 1, r = 42 === e ? T.star : T.modulo;
                        ...
                        if (!n && !e && this.options.ecmaVersion >= 11 && 110 === r) {
                            var i = this.input.slice(t, this.pos), s = "undefined" != typeof BigInt ? BigInt(i) : null;
                        ...
                        var a = this.input.slice(t, this.pos), o = n ? parseInt(a, 8) : parseFloat(a);
        ...
        3: [
            function(e, t, n) {
                function r(e, t = {}) {
                    const { contextName: n = "gl", throwGetError: r, useTrackablePrimitives: o, readPixelsFile: u, recording: l = [], variables: h = {}, onReadPixels: c, onUnrecognizedArgumentLookup: p } = t, d = new Proxy(e, {
                        get: function(t, d) {
                            switch(d){
                                case "addComment":
                                    return w;
                            ...
                            if ("function" == typeof e[d]) return function() {
                                switch(d){
                                    ...
                                    case "readPixels":
                                        ...
                                        if (-1 === t) {
                                            ...
                                            e ? (a1 = e, l.push(`${y}${e}`)) : (a1 = `${n}Variable${m.length}`, m.push(arguments[6]), l.push(`${y}const ${a1} = new ${arguments[6].constructor.name}(${arguments[6].length});`));
                                        } else a1 = `${n}Variable${t}`;
                                        g = a1;
                                        const d1 = [
                                            arguments[0],
                                            arguments[1],
                                        ...
                                        return l.push(`${y}${n}.readPixels(${d1.join(", ")});`), u && E(arguments[2], arguments[3]), c && c(a1, d1), e.readPixels.apply(e, arguments);
                                    case "drawBuffers":
                                        return l.push(`${y}${n}.drawBuffers([${s(arguments[0], {
                                            contextName: n,
                                            contextVariables: m,
                                            getEntity: S,
                                            addVariable: _,
                                ...
                                let t1 = e[d].apply(e, arguments);
                                switch(typeof t1){
                                    case "undefined":
                                        return void l.push(`${y}${I(d, arguments)};`);
                                    case "number":
                                    case "boolean":
                                        if (o && -1 === m.indexOf(a(t1))) {
                                            l.push(`${y}const ${n}Variable${m.length} = ${I(d, arguments)};`), m.push(t1 = a(t1));
                                            break;
                                        }
                                    default:
                                        null === t1 ? l.push(`${I(d, arguments)};`) : l.push(`${y}const ${n}Variable${m.length} = ${I(d, arguments)};`), m.push(t1);
                                }
                                return t1;
                            };
                            return f[e[d]] = d, e[d];
                    ...
                    function E(e, t) {
                        const r = `${n}Variable${m.length}`, i = `imageDatum${x}`;
                ...
                function i(e, t) {
                    const n = new Proxy(e, {
                        get: function(t, n) {
                            if ("function" == typeof t[n]) return function() {
                                if ("drawBuffersWEBGL" === n) return h.push(`${p}${i}.drawBuffersWEBGL([${s(arguments[0], {
                                    contextName: i,
                                    contextVariables: o,
                                    getEntity: m,
                                    addVariable: g,
                    ...
                    }), r = {}, { contextName: i, contextVariables: o, getEntity: u, useTrackablePrimitives: l, recording: h, variables: c, indent: p, onUnrecognizedArgumentLookup: d } = t;
                    return n;
                    function m(e) {
                ...
                function s(e, t) {
                    ...
                    return Array.from(e).map((e)=>{
                        const i = function(e) {
                            if (n) {
                                for(const t in n)if (n.hasOwnProperty(t) && n[t] === e) return t;
                            }
                            if (r) return r(e);
                            return null;
                        }(e);
                        return i || function(e, t) {
                            const { contextName: n, contextVariables: r, getEntity: i, addVariable: s, onUnrecognizedArgumentLookup: a } = t;
                            ...
                            switch(e.constructor.name){
                                case "String":
                                    const t1 = /\n/.test(e), n1 = /'/.test(e), r1 = /"/.test(e);
                                    return t1 ? "`" + e + "`" : n1 && !r1 ? '"' + e + '"' : "'" + e + "'";
                                case "Number":
                                case "Boolean":
                                    return i(e);
                                case "Array":
        ...
        4: [
            function(e, t, n) {
                ...
                function o() {
                    const e = r(arguments), t = new Array(this.output.z);
                ...
                function u(e) {
                    e.setOutput = (t)=>{
                        ...
                        return t ? function(e, t, n) {
                            const r = n / 2 | 0, i = 4 * t, s = new Uint8ClampedArray(4 * t), a = e.slice(0);
                            for(let e = 0; e < r; ++e){
                                const t = e * i, r = (n - e - 1) * i;
                        ...
                        const s = e.output.x, a = e.output.y, o = e.thread.x + (a - e.thread.y - 1) * s;
                    ...
                    CPUFunctionNode: class extends r {
                        ...
                        astVariableDeclaration(e, t) {
                            ...
                            for(let e = 0; e < n.length; e++){
                                e > 0 && t.push(",");
                                const r = n[e], i = this.getDeclaration(r.id);
                        ...
                        astMemberExpression(e, t) {
                            const { signature: n, type: r, property: i, xProperty: s, yProperty: a, zProperty: o, name: u, origin: l } = this.getMemberExpressionDetails(e);
                            switch(n){
                        ...
                        astArrayExpression(e, t) {
                            const n = this.getType(e), r = e.elements.length, i = [];
                            for(let t = 0; t < r; ++t){
                                const n = [];
            ...
            function(e, t, n) {
                ...
                t.exports = {
                    cpuKernelString: function(e, t) {
                        const n = [], i = [], s = [], a = !/^function/.test(e.color.toString());
                        if (n.push("  const { context, canvas, constants: incomingConstants } = settings;", `  const output = new Int32Array(${JSON.stringify(Array.from(e.output))});`, `  const _constantTypes = ${JSON.stringify(e.constantTypes)};`, `  const _constants = ${function(e, t) {
                            const n = [];
                            for(const r in t){
                        ...
                        const o = [], u = Object.keys(e.constantTypes);
        ...
        8: [
            function(e, t, n) {
                const { Kernel: r } = e("../kernel"), { FunctionBuilder: i } = e("../function-builder"), { CPUFunctionNode: s } = e("./function-node"), { utils: a } = e("../../utils"), { cpuKernelString: o } = e("./kernel-string");
                t.exports = {
                    CPUKernel: class extends r {
                        ...
                        color(e, t, n, r) {
                            ...
                            const i = this.output[0], s = this.output[1], a = this.thread.x + (s - this.thread.y - 1) * i;
                        ...
                        getKernelString() {
                            ...
                            let e = null, { translatedSources: t } = this;
                        ...
                        _earlyThrows() {
                            ...
                            const t = [];
                            for(let n = 0; n < e.length; n++){
                                const r = e[n], i = this._mapSubKernels((e)=>`user_${r} === result_${e.name}`).join(" || ");
                        ...
                        _mediaTo2DArray(e) {
                            const t = this.canvas, n = e.width > 0 ? e.width : e.videoWidth, r = e.height > 0 ? e.height : e.videoHeight;
            ...
            function(e, t, n) {
                class r {
                    static fromKernel(e, t, n) {
                        const { kernelArguments: i, kernelConstants: s, argumentNames: a, argumentSizes: o, argumentBitRatios: u, constants: l, constantBitRatios: h, debug: c, loopMaxIterations: p, nativeFunctions: d, output: m, optimizeFloatMemory: f, precision: g, plugins: x, source: y, subKernels: b, functions: T, leadingReturnStatement: v, followingReturnStatement: S, dynamicArguments: A, dynamicOutput: _ } = e, E = new Array(i.length), w = {};
                        for(let e = 0; e < i.length; e++)E[e] = i[e].type;
                        for(let e = 0; e < s.length; e++){
                            const t = s[e];
                            w[t.name] = t.type;
                        }
                        const k = (e, t)=>G.needsArgumentType(e, t), I = (e, t, n)=>{
                            G.assignArgumentType(e, t, n);
                        }, D = (e, t, n)=>G.lookupReturnType(e, t, n), C = (e)=>G.lookupFunctionArgumentTypes(e), $ = (e, t)=>G.lookupFunctionArgumentName(e, t), L = (e, t)=>G.lookupFunctionArgumentBitRatio(e, t), R = (e, t, n, r)=>{
                    ...
                    getPrototypesFromFunctionNames(e) {
                        const t = [];
                        for(let n = 0; n < e.length; ++n){
                            const r = e[n], i = this.nativeFunctionNames.indexOf(r);
                            if (i > -1) {
                    ...
                    lookupFunctionArgumentBitRatio(e, t) {
                        ...
                        const n = this._getFunction(e), r = n.argumentNames.indexOf(t);
                    ...
                    assignArgumentBitRatio(e, t, n, r) {
                        ...
                        const s = this._getFunction(n), a = i.argumentNames.indexOf(t);
                    ...
                    getReturnTypes() {
                        ...
                        for(let n = 0; n < t.length; n++){
                            const r = t[n], i = this.functionMap[r];
                            e[r] = i.getType(i.ast);
                        }
                        return e;
                    }
        ...
        10: [
            function(e, t, n) {
                const r = e("acorn"), { utils: i } = e("../utils"), { FunctionTracer: s } = e("./function-tracer");
                const a = {
                    Number: "Number",
                    Float: "Float",
                    Integer: "Integer",
                ...
                t.exports = {
                    FunctionNode: class {
                        ...
                        traceFunctionAST(e) {
                            const { contexts: t, declarations: n, functions: r, identifiers: i, functionCalls: a } = new s(e);
                            this.contexts = t, this.identifiers = i, this.functionCalls = a, this.functions = r;
                            for(let e = 0; e < n.length; e++){
                                const t = n[e], { ast: r, inForLoopInit: i, inForLoopTest: s } = t, { init: a } = r, o = this.getDependencies(a);
                                let u = null;
                                if (i && s) u = "Integer";
                                else if (a) {
                        ...
                        isAstMathVariable(e) {
                            return "MemberExpression" === e.type && e.object && "Identifier" === e.object.type && "Math" === e.object.name && e.property && "Identifier" === e.property.type && [
                                "E",
                                "PI",
                                "SQRT2",
                                "SQRT1_2",
                        ...
                        isAstMathFunction(e) {
                            return "CallExpression" === e.type && e.callee && "MemberExpression" === e.callee.type && e.callee.object && "Identifier" === e.callee.object.type && "Math" === e.callee.object.name && e.callee.property && "Identifier" === e.callee.property.type && [
                                "abs",
                                "acos",
                                "acosh",
                                "asin",
                        ...
                        astErrorOutput(e, t) {
                            ...
                            const n = i.getAstString(this.source, t), r = this.source.substr(t.start).split(/\n/), s = r.length > 0 ? r[r.length - 1] : 0;
                        ...
                        findIdentifierOrigin(e) {
                            ...
                            for(; t.length > 0;){
                                ...
                                else if (Array.isArray(n)) for(let e = 0; e < n.length; e++)t.push(n[e]);
                            }
                            return null;
                        }
                        findLastReturn(e) {
                            ...
                            for(; t.length > 0;){
                                ...
                                if ("FunctionDeclaration" !== e.type) if (e.argument) t.push(e.argument);
                                else if (e.body) t.push(e.body);
                                else if (e.declarations) t.push(e.declarations);
                                else if (Array.isArray(e)) for(let n = 0; n < e.length; n++)t.push(e[n]);
        ...
        11: [
            function(e, t, n) {
                ...
                const s = "trackIdentifiers", a = "memberExpression", o = "inForLoopInit";
                t.exports = {
                    FunctionTracer: class {
                        ...
                        getDeclaration(e) {
                            const { currentContext: t, currentFunctionContext: n, runningContexts: r } = this, i = t[e] || n[e] || null;
                            if (!i && t === n && r.length > 0) {
                        ...
                        scan(e) {
                            if (e) if (Array.isArray(e)) for(let t = 0; t < e.length; t++)this.scan(e[t]);
                            else switch(e.type){
                                case "Program":
                                ...
                                case "VariableDeclarator":
                                    {
                                        const { currentContext: t } = this, n = this.hasState(o), r = {
                                            ast: e,
                                            context: t,
                                            name: e.id.name,
                                            origin: "declaration",
        ...
        12: [
            function(e, t, n) {
                const { glWiretap: r } = e("gl-wiretap"), { utils: i } = e("../../utils");
                function s(e) {
                ...
                function o(e, t, n) {
                    const r = e.toArray.toString(), s = !/^function/.test(r);
                    return `() => {\n  function framebuffer() { return ${n}; };\n  ${i.flattenFunctionToString(`${s ? "function " : ""}${r}`, {
                        findDependency: (t, n)=>{
                            if ("utils" === t) return `const ${n} = ${i[n].toString()};`;
                            if ("this" === t) return "framebuffer" === n ? "" : `${s ? "function " : ""}${e[n].toString()}`;
                ...
                t.exports = {
                    glKernelString: function(e, t, n, l, h) {
                        ...
                        let m = !1, f = 0;
                        const { source: g, canvas: x, output: y, pipeline: b, graphical: T, loopMaxIterations: v, constants: S, optimizeFloatMemory: A, precision: _, fixIntegerDivisionAccuracy: E, functions: w, nativeFunctions: k, subKernels: I, immutable: D, argumentTypes: C, constantTypes: $, kernelArguments: L, kernelConstants: R, tactic: F } = n, N = new e(g, {
                            canvas: x,
                            context: d,
                            checkContext: !1,
                            output: y,
                        ...
                        if (d.setIndent(2), N.build.apply(N, t), V.push(d.toString()), d.reset(), N.kernelArguments.forEach((e, n)=>{
                            ...
                            if (N.renderKernels) {
                                const t = N.renderKernels(), n = d.getContextVariableName(N.texture.texture);
                                V.push(`    return {\n      result: {\n        texture: ${n},\n        type: '${t.result.type}',\n        toArray: ${o(t.result, n, e)}\n      },`);
                                const { subKernels: r, mappedTextures: i } = N;
                                for(let n = 0; n < r.length; n++){
                                    const s = i[n], a = r[n], u = t[a.property], l = d.getContextVariableName(s.texture);
                                    V.push(`\n      ${a.property}: {\n        texture: ${l},\n        type: '${u.type}',\n        toArray: ${o(u, l, e)}\n      },`);
                                }
                                V.push("    };");
                            } else {
                                const t = N.renderOutput(), n = d.getContextVariableName(N.texture.texture);
                                V.push(`    return {\n        texture: ${n},\n        type: '${t.type}',\n        toArray: ${o(t, n, e)}\n      };`);
                            }
                        }
                        V.push("    " + (h ? "\n" + h + "    " : "")), V.push(p.join("\n")), V.push("  };"), N.graphical && (V.push(function(e) {
                            const t = e.getPixels.toString(), n = !/^function/.test(t);
            ...
            function(e, t, n) {
                ...
                t.exports = {
                    GLKernel: class extends r {
                        ...
                        static getFeatures() {
                            const e = this.testContext, t = this.getIsDrawBuffers();
                            return Object.freeze({
                        ...
                        static nativeFunctionArguments(e) {
                            const t = [], n = [], r = [], i = /^[a-zA-Z_]/, s = /[a-zA-Z_0-9]/;
                            let a = 0, o = null, u = null;
                            for(; a < e.length;){
                                const l = e[a], h = e[a + 1], c = r.length > 0 ? r[r.length - 1] : null;
                                if ("FUNCTION_ARGUMENTS" !== c || "/" !== l || "*" !== h) if ("MULTI_LINE_COMMENT" !== c || "*" !== l || "/" !== h) if ("FUNCTION_ARGUMENTS" !== c || "/" !== l || "/" !== h) if ("COMMENT" !== c || "\n" !== l) if (null !== c || "(" !== l) {
                        ...
                        pickRenderStrategy(e) {
                            ...
                            if ("unsigned" === this.precision) if (this.renderRawOutput = this.readPackedPixelsToUint8Array, this.transferValues = this.readPackedPixelsToFloat32Array, this.pipeline) switch(this.renderOutput = this.renderTexture, null !== this.subKernels && (this.renderKernels = this.renderKernelsToTextures), this.returnType){
                                case "LiteralInteger":
                                case "Float":
                                case "Number":
                                case "Integer":
                        ...
                        readPackedPixelsToUint8Array() {
                            ...
                            const { texSize: e, context: t } = this, n = new Uint8Array(e[0] * e[1] * 4);
                        ...
                        readFloatPixelsToFloat32Array() {
                            ...
                            const { texSize: e, context: t } = this, n = e[0], r = e[1], i = new Float32Array(n * r * 4);
                            return t.readPixels(0, 0, n, r, t.RGBA, t.FLOAT, i), i;
                        }
                        getPixels(e) {
                            const { context: t, output: n } = this, [r, s] = n, a = new Uint8Array(r * s * 4);
                        ...
                        renderKernelsToTextures() {
                            ...
                            if (this.immutable) for(let t = 0; t < this.subKernels.length; t++)e[this.subKernels[t].property] = this.mappedTextures[t].clone();
                            else for(let t = 0; t < this.subKernels.length; t++)e[this.subKernels[t].property] = this.mappedTextures[t];
                            return e;
                        }
                        ...
                        setOutput(e) {
                            ...
                            if (this.program) {
                                ...
                                if (s) {
                                    const t = this.getVariablePrecisionString(s, this.tactic), n = this.getVariablePrecisionString(r, this.tactic);
                        ...
                        switchKernels(e) {
                            this.switchingKernels ? this.switchingKernels.push(e) : this.switchingKernels = [
                                e
                            ];
                        }
                        getVariablePrecisionString(e = this.texSize, t = this.tactic, n = !1) {
                            if (!t) {
                                ...
                                const t = this.constructor.features[n ? "lowIntPrecision" : "lowFloatPrecision"], r = this.constructor.features[n ? "mediumIntPrecision" : "mediumFloatPrecision"], i = this.constructor.features[n ? "highIntPrecision" : "highFloatPrecision"], s = Math.log2(e[0] * e[1]);
        ...
        14: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { GLTextureFloat: i } = e("./float");
                t.exports = {
        ...
        25: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { GLTexture: i } = e("./index");
                t.exports = {
                    GLTextureFloat: class extends i {
                        ...
                        renderRawOutput() {
                            const e = this.context, t = this.size;
                    ...
                    GLTexture: class extends r {
                        ...
                        clear() {
                            if (this.texture._refs) {
                                this.texture._refs--;
                                const e = this.context, t = this.texture = e.createTexture();
                                i(e, t);
                                const n = this.size;
        ...
        31: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { GLTextureUnsigned: i } = e("./unsigned");
                t.exports = {
        ...
        34: [
            function(e, t, n) {
                const r = e("gl"), { WebGLKernel: i } = e("../web-gl/kernel"), { glKernelString: s } = e("../gl/kernel-string");
                let a = null, o = null, u = null, l = null, h = null;
                t.exports = {
        ...
        35: [
            function(e, t, n) {
                t.exports = {
                    KernelValue: class {
                        constructor(e, t){
                            const { name: n, kernel: r, context: i, checkContext: s, onRequestContextHandle: a, onUpdateValueMismatch: o, origin: u, strictIntegers: l, type: h, tactic: c } = t;
        ...
        36: [
            function(e, t, n) {
                const { utils: r } = e("../utils"), { Input: i } = e("../input");
                t.exports = {
                    Kernel: class {
                        static get isSupported() {
                                ...
                                switch(t){
                                    ...
                                    case "nativeFunctions":
                                        ...
                                        for(let t = 0; t < e.nativeFunctions.length; t++){
                                            const n = e.nativeFunctions[t], { name: r, source: i } = n;
                        ...
                        addNativeFunction(e, t, n = {}) {
                            const { argumentTypes: r, argumentNames: i } = n.argumentTypes ? function(e) {
                        ...
                        setupArguments(e) {
                            if (this.kernelArguments = [], this.argumentTypes) for(let e = 0; e < this.argumentTypes.length; e++)this.kernelArguments.push({
                                ...
                                for(let t = 0; t < e.length; t++){
                                    const n = r.getVariableType(e[t], this.strictIntegers), i = "Integer" === n ? "Number" : n;
                        ...
                        toKernelOutput(e) {
                            return e.hasOwnProperty("x") ? e.hasOwnProperty("y") ? e.hasOwnProperty("z") ? [
                                e.x,
                                e.y,
                                e.z
                            ] : [
                        ...
                        static getArgumentTypes(e, t) {
                            ...
                            for(let i = 0; i < t.length; i++){
                                const s = t[i], a = e.argumentTypes[i];
        ...
        38: [
            function(e, t, n) {
                const { utils: r } = e("../../utils"), { FunctionNode: i } = e("../function-node");
                const s = {
                    Array: "sampler2D",
                    "Array(2)": "vec2",
                    "Array(3)": "vec3",
                ...
                t.exports = {
                    WebGLFunctionNode: class extends i {
                        ...
                        astConditionalExpression(e, t) {
                            if ("ConditionalExpression" !== e.type) throw this.astErrorOutput("Not a conditional expression", e);
                            const n = this.getType(e.consequent), r = this.getType(e.alternate);
                        ...
                        astBinaryExpression(e, t) {
                            ...
                            t.push("(");
                            const n = this.getType(e.left) || "Number", r = this.getType(e.right) || "Number";
                        ...
                        astIdentifierExpression(e, t) {
                            if ("Identifier" !== e.type) throw this.astErrorOutput("IdentifierExpression - not an Identifier", e);
                            const n = this.getType(e), i = r.sanitizeName(e.name);
                        ...
                        astAssignmentExpression(e, t) {
                            if ("%=" === e.operator) this.astGeneric(e.left, t), t.push("="), t.push("mod("), this.astGeneric(e.left, t), t.push(","), this.astGeneric(e.right, t), t.push(")");
                                ...
                                if ("**=" !== e.operator) {
                                    const n = this.getType(e.left), r = this.getType(e.right);
                        ...
                        astVariableDeclaration(e, t) {
                            ...
                            for(let t = 0; t < n.length; t++){
                                const i = n[t], l = i.init, h = this.getDeclaration(i.id), c = this.getType(i.init);
                                let p = c;
                        ...
                        astSwitchStatement(e, t) {
                            ...
                            const { discriminant: n, cases: r } = e, i = this.getType(n), s = `switchDiscriminant${this.astKey(e, "_")}`;
                            switch(i){
                                case "Float":
                                case "Number":
                        ...
                        astMemberExpression(e, t) {
                            const { property: n, name: i, signature: s, origin: a, type: o, xProperty: u, yProperty: l, zProperty: h } = this.getMemberExpressionDetails(e);
                            switch(s){
                                case "value.thread.value":
                                case "this.thread.value":
                                ...
                                case "value.value":
                                    ...
                                    const s1 = r.sanitizeName(i);
                                    switch(n){
                                        case "r":
                                            return t.push(`user_${s1}.r`), t;
                                        case "g":
                                            return t.push(`user_${s1}.g`), t;
                                        case "b":
                                            return t.push(`user_${s1}.b`), t;
                                        case "a":
                                            return t.push(`user_${s1}.a`), t;
                                    }
                                    break;
                                case "this.constants.value":
                        ...
                        astCallExpression(e, t) {
                            ...
                            if (this.onFunctionCall && this.onFunctionCall(this.name, n, e.arguments), t.push(n), t.push("("), i) for(let n = 0; n < e.arguments.length; ++n){
                                const r = e.arguments[n], i = this.getType(r);
                        ...
                        astArrayExpression(e, t) {
                            const n = this.getType(e), r = e.elements.length;
                            switch(n){
                                case "Matrix(2)":
                                case "Matrix(3)":
                                case "Matrix(4)":
        ...
        40: [
            function(e, t, n) {
                const { WebGLKernelValue: r } = e("./index"), { Input: i } = e("../../../input");
                t.exports = {
        ...
        44: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValue: i } = e("./index");
                t.exports = {
        ...
        45: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueHTMLImage: i } = e("./html-image");
                t.exports = {
                    WebGLKernelValueDynamicHTMLImage: class extends i {
                        ...
                        updateValue(e) {
                            ...
                            this.checkSize(t, n), this.dimensions = [
                                t,
                                n,
                                1
                            ], this.textureSize = [
                                t,
                                n
                            ], this.kernel.setUniform3iv(this.dimensionsId, this.dimensions), this.kernel.setUniform2iv(this.sizeId, this.textureSize), super.updateValue(e);
                        }
                    }
                };
            },
        ...
        46: [
            function(e, t, n) {
                const { WebGLKernelValueDynamicHTMLImage: r } = e("./dynamic-html-image");
                t.exports = {
        ...
        47: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueMemoryOptimizedNumberTexture: i } = e("./memory-optimized-number-texture");
                t.exports = {
        ...
        48: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueNumberTexture: i } = e("./number-texture");
                t.exports = {
        ...
        49: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleArray: i } = e("./single-array");
                t.exports = {
        ...
        50: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleArray1DI: i } = e("./single-array1d-i");
                t.exports = {
        ...
        51: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleArray2DI: i } = e("./single-array2d-i");
                t.exports = {
        ...
        52: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleArray3DI: i } = e("./single-array3d-i");
                t.exports = {
        ...
        53: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleInput: i } = e("./single-input");
                t.exports = {
        ...
        54: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueUnsignedArray: i } = e("./unsigned-array");
                t.exports = {
        ...
        55: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueUnsignedInput: i } = e("./unsigned-input");
                t.exports = {
                    WebGLKernelValueDynamicUnsignedInput: class extends i {
                        ...
                        updateValue(e) {
                            ...
                            this.dimensions = new Int32Array([
                                ...
                                n || 1,
                                i || 1
                            ]), this.textureSize = r.getMemoryOptimizedPackedTextureSize(this.dimensions, this.bitRatio), this.uploadArrayLength = this.textureSize[0] * this.textureSize[1] * (4 / this.bitRatio), this.checkSize(this.textureSize[0], this.textureSize[1]);
        ...
        57: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelArray: i } = e("./array");
                t.exports = {
        ...
        59: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { KernelValue: i } = e("../../kernel-value");
                t.exports = {
        ...
        61: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelArray: i } = e("./array"), s = "Source and destination textures are the same.  Use immutable = true and manually cleanup kernel output texture memory with texture.delete()";
                t.exports = {
                    WebGLKernelValueMemoryOptimizedNumberTexture: class extends i {
                        ...
                        updateValue(e) {
                            ...
                            if (t.pipeline) if (t.immutable) t.updateTextureArgumentRefs(this, e);
                            else {
        ...
        62: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelArray: i } = e("./array"), { sameError: s } = e("./memory-optimized-number-texture");
                t.exports = {
                ...
                t.exports = {
                    WebGLKernelValueSingleArray1DI: class extends i {
                        ...
                        setShape(e) {
                            ...
                            this.textureSize = r.getMemoryOptimizedFloatTextureSize(t, this.bitRatio), this.dimensions = new Int32Array([
                                t[1],
                                1,
                                1
                    ...
                    WebGLKernelValueSingleInput: class extends i {
                        constructor(e, t){
                            ...
                            this.dimensions = new Int32Array([
                                ...
                                i || 1,
                                s || 1
                            ]), this.textureSize = r.getMemoryOptimizedFloatTextureSize(this.dimensions, this.bitRatio), this.uploadArrayLength = this.textureSize[0] * this.textureSize[1] * this.bitRatio, this.checkSize(this.textureSize[0], this.textureSize[1]), this.uploadValue = new Float32Array(this.uploadArrayLength);
                        }
                        getStringValueHandler() {
                            return r.linesToString([
                                `const uploadValue_${this.name} = new Float32Array(${this.uploadArrayLength})`,
        ...
        70: [
            function(e, t, n) {
                const { GLKernel: r } = e("../gl/kernel"), { FunctionBuilder: i } = e("../function-builder"), { WebGLFunctionNode: s } = e("./function-node"), { utils: a } = e("../../utils"), o = e("../../plugins/math-random-uniformly-distributed"), { fragmentShader: u } = e("./fragment-shader"), { vertexShader: l } = e("./vertex-shader"), { glKernelString: h } = e("../gl/kernel-string"), { lookupKernelValueType: c } = e("./kernel-value-maps");
                let p = null, d = null, m = null, f = null, g = null;
                const x = [
                    o
                ], y = [], b = {};
                t.exports = {
                    WebGLKernel: class extends r {
                        ...
                        setupArguments(e) {
                            ...
                            let r = 0;
                            const i = ()=>this.createTexture(), s = ()=>this.constantTextureCount + r++, o = (e)=>{
                                this.switchKernels({
                            ...
                            for(let r = 0; r < e.length; r++){
                                const l = e[r], h = this.argumentNames[r];
                                let c;
                        ...
                        build() {
                            ...
                            const s = this.getVertexShader(arguments), a = n.createShader(n.VERTEX_SHADER);
                            n.shaderSource(a, s), n.compileShader(a), this.vertShader = a;
                            const o = this.getFragmentShader(arguments), u = n.createShader(n.FRAGMENT_SHADER);
                        ...
                        run() {
                            const { kernelArguments: e, texSize: t, forceUploadKernelConstants: n, context: r } = this;
                        ...
                        _setupOutputTexture() {
                            const e = this.context, t = this.texSize;
                        ...
                        _getConstantsString() {
                            const e = [], { threadDim: t, texSize: n } = this;
        ...
        73: [
            function(e, t, n) {
                const { utils: r } = e("../../utils"), { WebGLFunctionNode: i } = e("../web-gl/function-node");
                t.exports = {
        ...
        75: [
            function(e, t, n) {
                const { WebGLKernelValueArray2: r } = e("../../web-gl/kernel-value/array2");
                t.exports = {
        ...
        76: [
            function(e, t, n) {
                const { WebGLKernelValueArray3: r } = e("../../web-gl/kernel-value/array3");
                t.exports = {
        ...
        77: [
            function(e, t, n) {
                const { WebGLKernelValueArray4: r } = e("../../web-gl/kernel-value/array4");
                t.exports = {
        ...
        78: [
            function(e, t, n) {
                const { WebGLKernelValueBoolean: r } = e("../../web-gl/kernel-value/boolean");
                t.exports = {
        ...
        79: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGL2KernelValueHTMLImageArray: i } = e("./html-image-array");
                t.exports = {
        ...
        80: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueDynamicHTMLImage: i } = e("../../web-gl/kernel-value/dynamic-html-image");
                t.exports = {
        ...
        81: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGL2KernelValueDynamicHTMLImage: i } = e("./dynamic-html-image");
                t.exports = {
        ...
        82: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueDynamicMemoryOptimizedNumberTexture: i } = e("../../web-gl/kernel-value/dynamic-memory-optimized-number-texture");
                t.exports = {
        ...
        83: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueDynamicNumberTexture: i } = e("../../web-gl/kernel-value/dynamic-number-texture");
                t.exports = {
        ...
        84: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGL2KernelValueSingleArray: i } = e("../../web-gl2/kernel-value/single-array");
                t.exports = {
        ...
        85: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGL2KernelValueSingleArray1DI: i } = e("../../web-gl2/kernel-value/single-array1d-i");
                t.exports = {
        ...
        86: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGL2KernelValueSingleArray2DI: i } = e("../../web-gl2/kernel-value/single-array2d-i");
                t.exports = {
        ...
        87: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGL2KernelValueSingleArray3DI: i } = e("../../web-gl2/kernel-value/single-array3d-i");
                t.exports = {
        ...
        88: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGL2KernelValueSingleInput: i } = e("../../web-gl2/kernel-value/single-input");
                t.exports = {
        ...
        89: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueDynamicUnsignedArray: i } = e("../../web-gl/kernel-value/dynamic-unsigned-array");
                t.exports = {
        ...
        90: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueDynamicUnsignedInput: i } = e("../../web-gl/kernel-value/dynamic-unsigned-input");
                t.exports = {
        ...
        91: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueFloat: i } = e("../../web-gl/kernel-value/float");
                t.exports = {
        ...
        92: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelArray: i } = e("../../web-gl/kernel-value/array");
                t.exports = {
                    WebGL2KernelValueHTMLImageArray: class extends i {
                        constructor(e, t){
                            super(e, t), this.checkSize(e[0].width, e[0].height), this.dimensions = [
                                e[0].width,
                                e[0].height,
                                e.length
                            ], this.textureSize = [
        ...
        93: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueHTMLImage: i } = e("../../web-gl/kernel-value/html-image");
                t.exports = {
        ...
        94: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGL2KernelValueHTMLImage: i } = e("./html-image");
                t.exports = {
        ...
        95: [
            function(e, t, n) {
                const { WebGLKernelValueInteger: r } = e("../../web-gl/kernel-value/integer");
                t.exports = {
        ...
        96: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueMemoryOptimizedNumberTexture: i } = e("../../web-gl/kernel-value/memory-optimized-number-texture");
                t.exports = {
                    WebGL2KernelValueMemoryOptimizedNumberTexture: class extends i {
                        getSource() {
                            const { id: e, sizeId: t, textureSize: n, dimensionsId: i, dimensions: s } = this, a = this.getVariablePrecisionString();
                            return r.linesToString([
                                `uniform sampler2D ${e}`,
        ...
        97: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueNumberTexture: i } = e("../../web-gl/kernel-value/number-texture");
                t.exports = {
        ...
        98: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleArray: i } = e("../../web-gl/kernel-value/single-array");
                t.exports = {
        ...
        99: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleArray1DI: i } = e("../../web-gl/kernel-value/single-array1d-i");
                t.exports = {
        ...
        100: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleArray2DI: i } = e("../../web-gl/kernel-value/single-array2d-i");
                t.exports = {
        ...
        101: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleArray3DI: i } = e("../../web-gl/kernel-value/single-array3d-i");
                t.exports = {
        ...
        102: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueSingleInput: i } = e("../../web-gl/kernel-value/single-input");
                t.exports = {
        ...
        103: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueUnsignedArray: i } = e("../../web-gl/kernel-value/unsigned-array");
                t.exports = {
        ...
        104: [
            function(e, t, n) {
                const { utils: r } = e("../../../utils"), { WebGLKernelValueUnsignedInput: i } = e("../../web-gl/kernel-value/unsigned-input");
                t.exports = {
        ...
        105: [
            function(e, t, n) {
                const { WebGLKernel: r } = e("../web-gl/kernel"), { WebGL2FunctionNode: i } = e("./function-node"), { FunctionBuilder: s } = e("../function-builder"), { utils: a } = e("../../utils"), { fragmentShader: o } = e("./fragment-shader"), { vertexShader: u } = e("./vertex-shader"), { lookupKernelValueType: l } = e("./kernel-value-maps");
                let h = null, c = null, p = null, d = null, m = null;
                t.exports = {
                    WebGL2Kernel: class extends r {
                        ...
                        _setupOutputTexture() {
                            ...
                            const t = e.createTexture(), n = this.texSize;
                        ...
                        _getTextureCoordinate() {
                            const e = this.subKernels, t = this.getVariablePrecisionString(this.texSize, this.tactic);
                            return null === e || e.length < 1 ? `in ${t} vec2 vTexCoord;\n` : `out ${t} vec2 vTexCoord;\n`;
                        }
                        _getMainArgumentsString(e) {
                            const t = [], n = this.argumentNames;
                            for(let r = 0; r < n.length; r++)t.push(this.kernelArguments[r].getSource(e[r]));
                            return t.join("");
                        }
                        getKernelString() {
        ...
        108: [
            function(e, t, n) {
                const { gpuMock: r } = e("gpu-mock.js"), { utils: i } = e("./utils"), { Kernel: s } = e("./backend/kernel"), { CPUKernel: a } = e("./backend/cpu/kernel"), { HeadlessGLKernel: o } = e("./backend/headless-gl/kernel"), { WebGL2Kernel: u } = e("./backend/web-gl2/kernel"), { WebGLKernel: l } = e("./backend/web-gl/kernel"), { kernelRunShortcut: h } = e("./kernel-run-shortcut"), c = [
                    o,
                    u,
                    l
                ], p = [
                    ...
                    GPU: class {
                        ...
                        chooseKernel() {
                            ...
                            if (this.context) {
                                ...
                                if (this.mode in d) m && !d[this.mode].isSupported || (e = d[this.mode]);
                                    ...
                                    for(let t = 0; t < c.length; t++)if (c[t].isSupported) {
                                        e = c[t];
                                        break;
                                    }
                        ...
                        createKernel(e, t) {
                            ...
                            const l = Object.assign({
                                ...
                                onRequestSwitchKernel: function t(r, i, a) {
                                    ...
                                    let o = null;
                                    if (a.signature && !s[a.signature] && (s[a.signature] = a), a.dynamicOutput) for(let e = r.length - 1; e >= 0; e--){
                                        const t = r[e];
                                        "outputPrecisionMismatch" === t.type && (o = t.needed);
                                    }
                                    const l = a.constructor, h = l.getArgumentTypes(a, i), c = l.getSignature(a, h), d = s[c];
                        ...
                        createKernelMap() {
                            ...
                            if (t && "object" == typeof t.argumentTypes && (r.argumentTypes = Object.keys(t.argumentTypes).map((e)=>t.argumentTypes[e])), Array.isArray(arguments[0])) {
                                ...
                                const e = arguments[0];
                                for(let t = 0; t < e.length; t++){
                                    const n = e[t].toString(), s = i.getFunctionNameFromString(n);
                                    r.subKernels.push({
                                        name: s,
                                        source: n,
                                        property: t
                        ...
                        combineKernels() {
                            ...
                            const t = arguments[0].canvas, n = arguments[0].context, r = arguments.length - 1;
        ...
        110: [
            function(e, t, n) {
                class r {
                    constructor(e, t){
                        this.value = e, Array.isArray(t) ? this.size = t : (this.size = new Int32Array(3), t.z ? this.size = new Int32Array([
                            t.x,
                            t.y,
                            t.z
                        ]) : t.y ? this.size = new Int32Array([
                            t.x,
                            t.y
                    ...
                    toArray() {
                        const { utils: t } = e("./utils"), [n, r, i] = this.size;
                        ...
                        let t = function() {
                            return e.build.apply(e, arguments), t = function() {
                                ...
                                if (e.switchingKernels) {
                                    const r = e.resetSwitchingKernels(), i = e.onRequestSwitchKernel(r, arguments, e);
        ...
        113: [
            function(e, t, n) {
                t.exports = {
                    Texture: class {
                        constructor(e){
                            const { texture: t, size: n, dimensions: r, output: i, context: s, type: a = "NumberTexture", kernel: o, internalFormat: u, textureFormat: l } = e;
        ...
        114: [
            function(e, t, n) {
                const r = e("acorn"), { Input: i } = e("./input"), { Texture: s } = e("./texture"), a = /function ([^(]*)/, o = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, u = /([^\s,]+)/g, l = {
                    systemEndianness: ()=>d,
                    getSystemEndianness () {
                    ...
                    getKernelTextureSize (e, t) {
                        ...
                        return e.optimizeFloatMemory && "single" === e.precision && (n = s = Math.ceil(s / 4)), r > 1 && n * r === s ? new Int32Array([
                            n,
                            r
                    ...
                    closestSquareDimensions (e) {
                        const t = Math.sqrt(e);
                        let n = Math.ceil(t), r = Math.floor(t);
                    ...
                    erectArray2: (e, t)=>{
                        const n = new Array(t), r = 4 * t;
                        let i = 0;
                        for(let t = 0; t < r; t += 4)n[i++] = e.subarray(t, t + 2);
                        return n;
                    },
                    erect2DArray2: (e, t, n)=>{
                        const r = new Array(n), i = 4 * t;
                        for(let s = 0; s < n; s++){
                            const n = new Array(t), a = s * i;
                            let o = 0;
                    ...
                    erect3DArray2: (e, t, n, r)=>{
                        const i = 4 * t, s = new Array(r);
                        for(let a = 0; a < r; a++){
                            const r = new Array(n);
                            for(let s = 0; s < n; s++){
                                const o = new Array(t), u = a * i * n + s * i;
                                let l = 0;
                    ...
                    erect2DArray3: (e, t, n)=>{
                        const r = 4 * t, i = new Array(n);
                        for(let s = 0; s < n; s++){
                            const n = new Array(t), a = s * r;
                            let o = 0;
                    ...
                    getMinifySafeName: (e)=>{
                        try {
                            const t = r.parse(`const value = ${e.toString()}`), { init: n } = t.body[0].declarations[0];
                ...
                }, h = /\$/, c = /__/, p = /_/, d = l.getSystemEndianness();
                t.exports = {
                    utils: l
                };
            },
