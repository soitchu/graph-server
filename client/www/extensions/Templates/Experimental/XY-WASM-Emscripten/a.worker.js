...
function handleMessage(e) {
    try {
        ...
        var _Module___emscripten_thread_crashed;
        err(`worker.js onmessage() captured an uncaught exception: ${ex}`);
        if (ex === null || ex === void 0 ? void 0 : ex.stack) err(ex.stack);
        (_Module___emscripten_thread_crashed = Module["__emscripten_thread_crashed"]) === null || _Module___emscripten_thread_crashed === void 0 ? void 0 : _Module___emscripten_thread_crashed.call(Module);
        throw ex;
    }
}
self.onmessage = handleMessage;
