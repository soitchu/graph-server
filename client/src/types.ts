declare const payload: XYWorkerPayload;
declare const YValues: Array<number>;
declare function calX(x: number): void;
declare function cal(x: number, y: number): Array<number>;
...
type GraphModes = GraphXY | GraphLineInter | GraphPoint;
