...
graphInstance2.state.graph.topLeft = [-16.856211655652075, 12.08551703147749]
graphInstance2.state.graph.bottomRight = [11.917647454346795, -8.136359185147104]
graphInstance2.translate = {x: 9.00634828601547, y: 6.1005383297656, iniX: 0.732160576866839, iniY: -0.207958376657112}
...
async function animate(graphInstance: Graph, remoteExt: Remote) {
  let redrawPromise: Promise<void> = remoteExt.redraw()
